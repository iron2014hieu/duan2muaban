...
public class ListSPAdapter extends RecyclerView.Adapter<ListSPAdapter.MyViewHolder> {
    Context context;
    ...
    public ListSPAdapter(Context context, List<DatMua> listGiohang) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view;
        view = LayoutInflater.from(context).inflate(R.layout.item_listsanpham, viewGroup, false);
