...
public class CountryData {
    public static final String[] countryNames = {"Việt Nam", "Albania",
            ...
            "Holy See (vatican City State)", "Venezuela", "Afghanistan",
            "Wallis And Futuna", "Yemen", "Zambia", "Zimbabwe"};

    public static final String[] countryAreaCodes = {"+84", "355", "213",
