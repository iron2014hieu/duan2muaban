//package com.iron2014.assiment_fns;
//
...
//import com.iron2014.assiment_fns.Session.SessionManager;
...
//        progressBar.setVisibility(View.VISIBLE);
//        FileLoader.with(this)
//                .load("http://hieuttpk808.000webhostapp.com/books/sach/files/MOB403%20-%20Lab6.pdf")
...
public class ViewBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, ""+book.get(sessionManager.TENSACH), Toast.LENGTH_SHORT).show();
        Dexter.withActivity(this)
                .withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                .withListener(new BaseMultiplePermissionsListener(){
                    @Override
        ...
        if (linkBook!= null) {
            ...
            FileLoader.with(this)
                    .load("http://hieuttpk808.000webhostapp.com/books/sach/files/MOB403%20-%20Lab7.pdf")
                    .fromDirectory("PDFFiles", FileLoader.DIR_EXTERNAL_PUBLIC)
                    .asFile(new FileRequestListener<File>() {
                        @Override
                        public void onLoad(FileLoadRequest request, FileResponse<File> response) {
